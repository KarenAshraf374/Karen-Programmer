...
Highly skilled **React.js (Web)** and **Flutter (Mobile) Developer** focused on building high-performance, scalable applications.  
Proven ability to integrate complex **RESTful APIs** and collaborate effectively in fast-paced **Agile environments**.  
Committed to **clean architecture**, efficient performance, and **timely delivery**.  
...
![Responsive UI/UX](https://img.shields.io/badge/-Responsive%20UI%2FUX-000000?style=flat-square)
...
![MVC/MVVM](https://img.shields.io/badge/-MVC%2FMVVM-0A66C2?style=flat-square)
...
![Security](https://img.shields.io/badge/-Security-181717?style=flat-square&logo=security&logoColor=white)
